      ...
      <div ref={containerRef} className="flex items-center">
        <RadixHoverCard.Trigger asChild>
          <NavLink
            ...
            prefetch="intent"
          >
            <div className="relative group about-dropdown-button px-[4px] py-2 rounded-md transition-colors  hover:text-primary cursor-pointer text-primary hover:bg-accent  text-sm font-md flex justify-center items-center">
              {menuItems.title}
              ...
              {enableMobileToggle && (
                <button
                  ...
                  aria-expanded={open}
                  className="dropdownbutton-about ps-[1px] text-primary"
                  onClick={(event) => {
